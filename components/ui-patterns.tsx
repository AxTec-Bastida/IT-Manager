...
export function MobileCard({
  ...
  return <article className={clsx("rounded-lg border border-slate-200 bg-white p-4 shadow-sm", className)}>{children}</article>;
}
  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        variant === "primary" ? "bg-slate-950 text-white hover:bg-slate-800" : "border border-slate-300 bg-white text-slate-700 hover:bg-slate-100",
        className,
      )}
    >
      {children}
